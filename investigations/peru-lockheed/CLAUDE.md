...
Case-specific instructions for agents working this profile. Loaded in addition to the project CLAUDE.md.
...
Per project CLAUDE.md, never set `confirmed` for inference or synthesis. For this case specifically:
