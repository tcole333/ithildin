...
| **Artifact metadata** — hashes, exact duplicates, timestamps, producer/client fingerprints, attachments, and coverage gaps | `tools/epstein_metadata.py` | `pilot --max-files 500`; `scan PATH... --collection NAME`; `report --reference-date 2019-07-06`; `show EFTA01091533`; `stats`. Values retain source/production/release/container/acquisition provenance layers; sensitive fields are redacted by default. |
