...
### Avatar Image
- **File**: `design/screenshots/gravatar-jeffreyepstein.jpg` (400x400 JPEG, 30KB)
...
- **jmail.world** — Browser-based Gmail-style archive of released Epstein emails (logged in as jeevacation@gmail.com)
...
- **jmail.world**: 6,857+ search results — one of the most prolific Epstein correspondents (2005-2018, 13 years)
...
- **jmail.world**: 9,116+ search results — massive correspondence archive
...
- **jmail.world**: 26 search results (May-Jun 2019)
...
- **jmail.world**: 93 total emails — one of the most prolific service contacts
...
### Karyna Shuliak — jmail.world Person Page Deep Dive
- **jmail.world person page**: `/person/karyna-shuliak` — **8,310 emails** (84 pages), 11,106 total referenced
- **Description on jmail**: "Belarusian model and dentist, Epstein's girlfriend until his death in 2019"
...
### Steve Bannon — jmail.world Person Page Deep Dive
- **jmail.world person page**: `/person/steve-bannon` — **526 emails** (6 pages)
...
**Note**: This covers only the House Oversight subset (~4,272 messages). The full DOJ releases contain significantly more (jmail.world indexes 526 Bannon emails alone vs 160 in this dataset).
...
| https://www.jmail.world/thread/EFTA02704568?view=inbox | Highbridge Capital investment emails |
...
- [ ] Identify the **Russian masseuse** in EFTA02387318 — download the original DOJ PDF which may have less redaction than jmail rendering
- [x] ~~Check jmail.world for Fettah Tamince / Rixos~~ — **MAJOR FIND**: 78 results. Full "Training Program" operation documented (Jun-Jul 2017). Two women placed at Rixos Belek (Antalya). Epstein paid with visa card. See Fettah Tamince section above.
...
- [ ] Search jmail.world for **"Training Program in Antalya"** — may find additional logistics emails on page 2
- [ ] Investigate phone **212-772-9416** — Epstein gave this to Sultan (Jan 2011). Is this NES LLC / 9 E 71st?
- [x] ~~Search jmail.world for Karyna Shuliak person page~~ — **MAJOR FIND**: 8,310 emails (84 pages). She was de facto property manager/Chief of Staff across all properties. See Karyna Shuliak jmail Deep Dive section above.
...
- [x] ~~Search jmail.world for **Steve Bannon** person page~~ — **MAJOR FIND**: 526 emails. Pages 1-2 documented. Bill Barr inquiry, Acosta/investigation intelligence, American Carnage editorial role, European heads of state connections, Kathy Ruemmler, Jide Zeitlin/Glencore, watch gifts via Sean Bannon.
- [ ] Search jmail.world for **Dain Valverde** — third traveler on Bannon's Norway trip
- [ ] Search jmail.world for **Kathy Ruemmler** person page — Obama's White House Counsel, Goldman Sachs GC, called Epstein 'Uncle Jeffrey', organized dinner with Bannon and Miroslav Lajcak
- [ ] Search jmail.world for **Jide Zeitlin** — Goldman Sachs partner, 153 Glencore documents, Tapestry CEO
- [ ] Search jmail.world for **Miroslav Lajcak** — UN GA President, resigned after files released, Epstein arranged dinner with Bannon
...
- [ ] Search jmail.world for **Karyna Shuliak page 2-84** — 8,210 more emails to review
...
- [x] **Sultan Bin Sulayem jmail.world deep dive** — 6,857+ results. Chairman DP World. Personal email ssulayem@me.com, work email Sultan.BinSulayem@dubaiworld.ae, cell +971506448444. Correspondence 2005-2018.
...
- [x] **Karyna Shuliak jmail.world person page explored** — 8,310 emails (84 pages). Reveals de facto property manager role across LSJ, NYC, Paris, Palm Beach. Managed staff (Bella Klein, Merwin Dela Cruz), authorized $5K cash, arranged Woody Allen dinner, hired housekeepers via Tsering Dolma, managed AED maintenance, directed renovations.
...
- [x] **Identified Max Churkin = Maxim Churkin** — son of Russia's UN Ambassador Vitaly Churkin. Father personally introduced him to Epstein (May 2016). Epstein gave laptop, tried to place at Glenn Dubin's firm, invited to Hasty Pudding. 9,116 jmail results. Still active Jun 2019.
