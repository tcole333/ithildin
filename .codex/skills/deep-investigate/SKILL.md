...
Use `spawn_agent` to launch the four independent sub-agents back-to-back before waiting. If the plan intentionally uses fewer tracks, define that exact expected report set before launch. Each agent gets:
- The target briefing
