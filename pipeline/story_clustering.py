...
CLUSTERS = [
    ...
    },
    {
        ...
        "subtitle": "Six months before his arrest, Epstein was the shared intelligence node between the two Big Law firms circling opposite sides of the Misra-Benedetti dirty-tricks scandal",
        "style_angle": "The interesting thing about 'the Softbank caper' is not the honey trap — it is the lawyer-broker geometry around it",
        "targets": [
            "Reid Weingarten", "Rajeev Misra", "Alessandro Benedetti",
            "Brad Karp", "Nikesh Arora", "Alok Sama",
            "Eduardo Teodorani-Fabbri", "Ron Soffer", "Mark MacDougall",
            "Matteo Bigazzi", "Michael Klein", "Larry Summers",
            "SoftBank Vision Fund", "SoftBank Group", "Steptoe & Johnson",
            "Paul Weiss", "Akin Gump", "K2 Intelligence", "Barkmere Group",
            "Standard Chartered",
        ],
        "keywords": [
            "softbank caper", "vision fund", "misra", "benedetti", "honey trap",
            "tokyo", "arora", "sama", "barkmere", "weingarten", "karp",
            "steptoe", "paul weiss", "BVI", "standard chartered", "K2",
            "project spring", "soffer", "teodorani", "baur au lac", "bigazzi",
            "macdougall", "wsj", "anivad", "wetherby select",
            "HOUSE_OVERSIGHT_028576", "HOUSE_OVERSIGHT_028601",
            "EFTA02628256", "EFTA02626821", "EFTA02627034",
        ],
    },
    {
