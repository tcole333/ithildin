...
Searches IRS Form 990 filings for nonprofit organizations.
Free API, no authentication required.

Usage:
    python tools/query_990.py search "Jeffrey Epstein"
    python tools/query_990.py ein 660789697
    python tools/query_990.py fulltext "Jeffrey Epstein"
